...
#### Task 5: Add a script to the HTML time to establish a WebSocket connection to the server.
...
#### Task 7: Modify the HTML structure to include a chat window and an input area for typing messages. Style the chat window and input area using C55.
...
#### Task 9. Add user authentication to the chat application, Allow users to enter a username before joining the chal Display usernames alongside their messages in the chat window.
